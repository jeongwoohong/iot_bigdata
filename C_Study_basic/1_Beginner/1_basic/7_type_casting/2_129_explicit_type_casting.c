...
void main(){
	...
	// 강제형변환(Explicit Type Casting)
	// 문법: (형이름)[상수/변수] => (doulbe)num1; (double)1;
	// Case1] 아래 예는 numerator 변수가 강제형변환 되었으며 따라서 실수와 정수간의 연산이 되므로
	// 정수형 변수인 denominator는 자동형변환(Implicit Type Casting)이 일어난다.
